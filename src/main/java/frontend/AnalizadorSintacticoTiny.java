...
public class AnalizadorSintacticoTiny implements AnalizadorSintacticoTinyConstants {
  ...
  final public DeclaredType tipo0() throws ParseException {
    ...
    case STRUCT:
      ...
      jj_consume_token(CLOSE_BRACE);
          {if (true) return ops.tStruct(fields, enlaceFuente(t));}
      break;
    default:
      jj_la1[6] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Map<String, DeclaredType> fields() throws ParseException {
   DeclaredType type; Token token; Map<String, DeclaredType> full;
    ...
    case identificador:
      ...
      jj_consume_token(SEMICOLON);
      full = fields();
         full.put(token.image, type); {if (true) return full;}
      break;
    default:
      jj_la1[8] = jj_gen;
     {if (true) return new HashMap<String, DeclaredType>();}
    }
    throw new Error("Missing return statement in function");
  }
  ...
  final public Inst iif() throws ParseException {
   Exp cond; Inst then; Inst inst; Token t;
    t = jj_consume_token(IF);
    cond = exp0();
    jj_consume_token(THEN);
    then = iblock();
    inst = riif(cond, then, t);
           {if (true) return inst;}
    throw new Error("Missing return statement in function");
  }

  final public Inst riif(Exp cond, Inst then, Token t) throws ParseException {
   Inst els;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ELSE:
      jj_consume_token(ELSE);
      els = iblock();
         {if (true) return ops.iifthenelse(cond, then, els);}
      break;
    default:
      jj_la1[11] = jj_gen;
     {if (true) return ops.iifthen(cond, then);}
    }
    throw new Error("Missing return statement in function");
  }
  ...
  final public Inst iwrite() throws ParseException {
   Token t; Token exp;
    ...
    exp = jj_consume_token(identificador);
    jj_consume_token(SEMICOLON);
     {if (true) return ops.iwrite(exp.image);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Inst iread() throws ParseException {
    ...
    exp = jj_consume_token(identificador);
    jj_consume_token(SEMICOLON);
       {if (true) return ops.iread(exp.image);}
    throw new Error("Missing return statement in function");
  }

  final public Inst iswitch() throws ParseException {
   Token t; List<ICase> cases; Inst inst; Exp cond;
    t = jj_consume_token(SWITCH);
    cond = exp0();
    jj_consume_token(OPEN_BRACE);
    cases = caseList();
    inst = riswitch(cond, cases, t);
     {if (true) return inst;}
    throw new Error("Missing return statement in function");
  }

  final public Inst riswitch(Exp cond, List<ICase> cases, Token t) throws ParseException {
   Inst definst;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case DEFAULTT:
      ...
      jj_consume_token(SEMICOLON);
      jj_consume_token(CLOSE_BRACE);
     {if (true) return ops.iswitch(cond, definst, cases);}
      break;
    case CLOSE_BRACE:
      jj_consume_token(CLOSE_BRACE);
     {if (true) return ops.iswitch(cond, cases);}
      break;
    default:
      jj_la1[12] = jj_gen;
      jj_consume_token(-1);
  ...
  final public List<ICase> caseList() throws ParseException {
   ICase icase; List<ICase> rest;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case CASE:
      icase = icase();
      rest = caseList();
     rest.add(icase); {if (true) return rest;}
      break;
    default:
      jj_la1[13] = jj_gen;
     {if (true) return new ArrayList<ICase>();}
    }
    throw new Error("Missing return statement in function");
  }

  final public ICase icase() throws ParseException {
   Token t; Exp exp; Inst inst;
    ...
    inst = instruccion();
    jj_consume_token(SEMICOLON);
   {if (true) return ops.icase(exp, inst);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Inst idowhile() throws ParseException {
    ...
    exp = exp0();
    jj_consume_token(SEMICOLON);
           {if (true) return ops.idowhile(i, exp);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public Exp exp3() throws ParseException {
    ...
    case MINUS:
      ...
      exp = exp3();
             {if (true) return ops.negative(exp,enlaceFuente(t));}
      break;
    case LESS:
      t = jj_consume_token(LESS);
      exp$castexp = castexp(t);
             {if (true) return exp$castexp;}
      break;
    case TRUE:
    case FALSE:
    case NULL:
  ...
  final public Exp castexp(Token t) throws ParseException {
   Exp exp;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case INT:
      ...
      exp = exp3();
     {if (true) return ops.intcast(exp, enlaceFuente(t));}
      break;
    case DOUBLE:
      t = jj_consume_token(DOUBLE);
      jj_consume_token(GREAT);
      exp = exp3();
     {if (true) return ops.realcast(exp, enlaceFuente(t));}
      break;
    case BOOL:
      t = jj_consume_token(BOOL);
      jj_consume_token(GREAT);
      exp = exp3();
     {if (true) return ops.boolcast(exp, enlaceFuente(t));}
      break;
    case CHAR:
      t = jj_consume_token(CHAR);
      jj_consume_token(GREAT);
      exp = exp3();
     {if (true) return ops.charcast(exp, enlaceFuente(t));}
      break;
    case STRING:
      t = jj_consume_token(STRING);
      jj_consume_token(GREAT);
      exp = exp3();
     {if (true) return ops.strcast(exp, enlaceFuente(t));}
      break;
    default:
      jj_la1[23] = jj_gen;
      jj_consume_token(-1);
  ...
  final public Exp exp7() throws ParseException {
    ...
    case NULL:
      t = jj_consume_token(NULL);
             {if (true) return ops.makeNull(enlaceFuente(t));}
      break;
    default:
      jj_la1[27] = jj_gen;
      jj_consume_token(-1);
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x160000,0x160000,0x160000,0x201f000,0x0,0x0,0x201f000,0x0,0x201f000,0x1f000,0x4da80c00,0x20000000,0x0,0x80000000,0x400000,0x0,0x4da80c00,0x4da80c00,0x0,0x0,0x0,0x0,0xc00,0x1f000,0x0,0x0,0xc00,0xc00,0xc00,};
   }
   private static void jj_la1_init_1() {
      jj_la1_1 = new int[] {0x0,0x0,0x0,0x0,0x1000000,0x10000000,0x0,0x80040,0x0,0x0,0xa2086e,0x0,0x400001,0x0,0x0,0x1000000,0xa2086e,0xa2086e,0x2000000,0x7e00,0x8030,0x101c0,0x820862,0x0,0x40000000,0x84080000,0x20042,0x20002,0x0,};
   }
   private static void jj_la1_init_2() {
      jj_la1_2 = new int[] {0x0,0x0,0x0,0x1,0x0,0x0,0x1,0x0,0x1,0x1,0x67,0x0,0x0,0x0,0x0,0x0,0x67,0x67,0x0,0x0,0x0,0x0,0x67,0x0,0x0,0x0,0x67,0x67,0x66,};
   }
