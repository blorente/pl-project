...
public class GeneracionDeCodigo extends Processing {
	...
	public void process(Equals exp) {
		...
		if (t1.equals(program.tReal()) || t2.equals(program.tReal())) {
			maquina.addInstruccion(maquina.equalsReal());
		} else if (t1.equals(program.tInt())) {
			maquina.addInstruccion(maquina.equalsInt());
		} else if (t1.equals(program.tBool())) {
			maquina.addInstruccion(maquina.equalsBool());			
		} else if (t1.equals(program.tUniChar())) {
			maquina.addInstruccion(maquina.equalsChar());			
		} else if (t1.equals(program.tUniString())) {
			maquina.addInstruccion(maquina.equalsString());			
		}
	}
	...
	public void process(NotEquals exp) {
		...
		if (t1.equals(program.tReal()) || t2.equals(program.tReal())) {
			maquina.addInstruccion(maquina.notEqualsReal());
		} else if (t1.equals(program.tInt())) {
			maquina.addInstruccion(maquina.notEqualsInt());
		} else if (t1.equals(program.tBool())) {
			maquina.addInstruccion(maquina.notEqualsBool());			
		} else if (t1.equals(program.tUniChar())) {
			maquina.addInstruccion(maquina.notEqualsChar());			
		} else if (t1.equals(program.tUniString())) {
			maquina.addInstruccion(maquina.notEqualsString());			
		}
	}
	...
	public void process(Greater exp) {
		...
		if (t1.equals(program.tReal()) || t2.equals(program.tReal())) {
			maquina.addInstruccion(maquina.greaterReal());
		} else if (t1.equals(program.tInt())) {
			maquina.addInstruccion(maquina.greaterInt());
		} else if (t1.equals(program.tBool())) {
			maquina.addInstruccion(maquina.greaterBool());			
		} else if (t1.equals(program.tUniChar())) {
			maquina.addInstruccion(maquina.greaterChar());			
		} else if (t1.equals(program.tUniString())) {
			maquina.addInstruccion(maquina.greaterString());			
		}
	}
	...
	public void process(GreaterEq exp) {
		...
		if (t1.equals(program.tReal()) || t2.equals(program.tReal())) {
			maquina.addInstruccion(maquina.greaterEqReal());
		} else if (t1.equals(program.tInt())) {
			maquina.addInstruccion(maquina.greaterEqInt());
		} else if (t1.equals(program.tBool())) {
			maquina.addInstruccion(maquina.greaterEqBool());			
		} else if (t1.equals(program.tUniChar())) {
			maquina.addInstruccion(maquina.greaterEqChar());			
		} else if (t1.equals(program.tUniString())) {
			maquina.addInstruccion(maquina.greaterEqString());			
		}
	}
	...
	public void process(Less exp) {
		...
		if (t1.equals(program.tReal()) || t2.equals(program.tReal())) {
			maquina.addInstruccion(maquina.lessReal());
		} else if (t1.equals(program.tInt())) {
			maquina.addInstruccion(maquina.lessInt());
		} else if (t1.equals(program.tBool())) {
			maquina.addInstruccion(maquina.lessBool());			
		} else if (t1.equals(program.tUniChar())) {
			maquina.addInstruccion(maquina.lessChar());			
		} else if (t1.equals(program.tUniString())) {
			maquina.addInstruccion(maquina.lessString());			
		}
	}
	...
	public void process(LessEq exp) {
		...
		if (t1.equals(program.tReal()) || t2.equals(program.tReal())){
			maquina.addInstruccion(maquina.lessEqReal());
		} else if (t1.equals(program.tInt())) {
			maquina.addInstruccion(maquina.lessEqInt());
		} else if (t1.equals(program.tBool())) {
			maquina.addInstruccion(maquina.lessEqBool());			
		} else if (t1.equals(program.tUniChar())) {
			maquina.addInstruccion(maquina.lessEqChar());			
		} else if (t1.equals(program.tUniString())) {
			maquina.addInstruccion(maquina.lessEqString());			
		}
	}
